...
// Create an obj
$marco = new User("Marco", "Valeri", "23/01/1984", "Male", "info@marcovaleri.net", 104, 115);
echo $marco->getUserData();
echo "\n";

// Create an obj
$caterina = new User("Caterina", "Giordo", "01/02/1986", "Female", "caterinagiordo@gmail.com", 50, 60);
